...
export default function App() {
  ...
  const translations = {
    fr: {
      ...
      deleteConfirmAdmin: "Êtes-vous sûr de vouloir supprimer définitivement le véhicule",
      dragOr: "Glisser ou",
      browse: "parcourir",
      mainImage: "Image Principale",
      photoGalleryLimit: "Galerie photos (jusqu'à 29 photos)",
      photosLabel: "Photos :",
      generalInfoStep: "1. Informations Générales",
      techSpecsStep: "2. Caractéristiques Techniques",
      mediaGalleryStep: "3. Médias & Galerie",
      powerHp: "Puissance (ch)",
      mileageKm: "Kilométrage (km)",
      priceEuro: "Prix (€)",
      co2gkm: "CO₂ (g/km)",
      certifyVin: "Certifier le VIN (Badge)",
      adminSpace: "Espace Administration",
      adminPasswordPrompt: "Veuillez saisir votre mot de passe pour gérer le catalogue.",
      passwordPlaceholder: "Mot de passe",
      login: "Se connecter",
      addCarCatalog: "Ajouter un véhicule au catalogue",
      closeEscape: "Fermer (Echap)",
      error: "Échec",
      edit: "Modifier",
      delete: "Supprimer",
      ...
      deleteWarning: "du catalogue ? Cette action est irréversible.",
    ...
    en: {
      ...
      deleteConfirmAdmin: "Are you sure you want to permanently delete the vehicle",
      dragOr: "Drag or",
      browse: "browse",
      mainImage: "Main Image",
      photoGalleryLimit: "Photo Gallery (up to 29 photos)",
      photosLabel: "Photos :",
      generalInfoStep: "1. General Information",
      techSpecsStep: "2. Technical Specifications",
      mediaGalleryStep: "3. Media & Gallery",
      powerHp: "Power (hp)",
      mileageKm: "Mileage (km)",
      priceEuro: "Price (€)",
      co2gkm: "CO₂ (g/km)",
      certifyVin: "Certify VIN (Badge)",
      adminSpace: "Administration Area",
      adminPasswordPrompt: "Please enter your password to manage the catalogue.",
      passwordPlaceholder: "Password",
      login: "Log In",
      addCarCatalog: "Add vehicle to catalogue",
      closeEscape: "Close (Esc)",
      error: "Error",
      edit: "Edit",
      delete: "Delete",
      ...
      messageLabel: "Message",
      deleteWarning: "from the catalogue? This action cannot be undone.",
      Electrique: "Electric",
    ...
    ru: {
      ...
      deleteConfirmAdmin: "Вы уверены, что хотите навсегда удалить автомобиль",
      dragOr: "Перетащите или",
      browse: "выберите",
      mainImage: "Главное фото",
      photoGalleryLimit: "Фотогалерея (до 29 фото)",
      photosLabel: "Фото:",
      generalInfoStep: "1. Общая информация",
      techSpecsStep: "2. Технические характеристики",
      mediaGalleryStep: "3. Медиа и Галерея",
      powerHp: "Мощность (л.с.)",
      mileageKm: "Пробег (км)",
      priceEuro: "Цена (€)",
      co2gkm: "CO₂ (г/км)",
      certifyVin: "Сертифицировать VIN (Бейдж)",
      adminSpace: "Панель администратора",
      adminPasswordPrompt: "Пожалуйста, введите пароль для управления каталогом.",
      passwordPlaceholder: "Пароль",
      login: "Войти",
      addCarCatalog: "Добавить авто в каталог",
      closeEscape: "Закрыть (Esc)",
      error: "Ошибка",
      edit: "Редактировать",
      delete: "Удалить",
      ...
      deleteWarning: "из каталога? Это действие необратимо.",
      Electrique: "Электро",
  ...
  const DEFAULT_SETTINGS = {
    ...
    stat3Number: "DOC",
    ru: {
      bannerTitle: "Покупка и Продажа Автомобилей с Пробегом и Новых во Франции",
    ...
    fr: {
      bannerTitle: "Achat & Vente de Véhicules d'Occasion et Neufs",
    ...
    en: {
      bannerTitle: "Buy & Sell Used and New Cars in France",
      bannerSubtitle: "Ligo Automobiles • France",
  ...
  const handleOpenAddModal = () => {
    setCarToEdit(null);
    setFormData({ brand: '', model: '', year: new Date().getFullYear(), km: '', price: '', fuel: 'Essence', transmission: 'Automatique', hp: '', co2: '', vin: '', status: 'En stock', image: '', description: '', verifiedVin: false, galleryImages: [] });
  ...
  return (
    <div className={`min-h-screen font-sans antialiased ${theme === 'dark' ? 'bg-[#0A0A0B] text-white' : 'bg-[#F8F9FA] text-neutral-900'}`}>
      ...
      {/* Хэдер */}
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-[#0A0A0B]/80 backdrop-blur-xl border-b border-neutral-200 dark:border-neutral-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div onClick={() => { setCurrentView('home'); setSelectedCar(null); window.scrollTo({ top: 0 }); }} className="cursor-pointer flex items-center gap-3">
            <span className="text-xl font-serif font-black tracking-wide text-neutral-900 dark:text-white">{siteSettings.companyName || "Ligo Automobiles"}</span>
          </div>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 sm:py-40 lg:py-48">
            <div className="max-w-2xl space-y-6">
              <div className="flex items-center gap-3">
                <span className="text-xs uppercase tracking-widest text-[#D4AF37] font-bold bg-[#D4AF37]/10 px-4 py-1.5 rounded-full border border-[#D4AF37]/20">
                  {siteSettings[lang]?.bannerSubtitle || DEFAULT_SETTINGS[lang].bannerSubtitle}
                </span>
              </div>
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-serif tracking-tight text-white leading-[1.15] font-black">
                {siteSettings[lang]?.bannerTitle || DEFAULT_SETTINGS[lang].bannerTitle}
              </h1>
              <p className="text-neutral-300 font-light leading-relaxed max-w-xl text-sm sm:text-base">
                {siteSettings[lang]?.bannerDescription || DEFAULT_SETTINGS[lang].bannerDescription}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button onClick={() => { setCurrentView('catalog'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="w-full sm:w-auto bg-[#D4AF37] hover:bg-[#D4AF37]/90 text-neutral-950 px-8 py-4 font-button text-xs uppercase tracking-widest hover:shadow-xl transition-all duration-300 rounded-2xl font-bold">
                  {t('discoverCatalog')}
                </button>
                <a href="#contact" onClick={(e) => { e.preventDefault(); document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }); }} className="w-full sm:w-auto text-center border border-white/20 hover:border-[#D4AF37]/50 text-white hover:text-[#D4AF37] px-8 py-4 font-button text-xs uppercase tracking-widest hover:shadow-xl transition-all duration-300 rounded-2xl font-bold">
                  {t('bookAppointment')}
                </a>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cars.slice(0, 6).map((car) => (
              <div key={car.id} className="group relative bg-white dark:bg-[#121214] border border-neutral-200 dark:border-neutral-900 hover:border-[#D4AF37]/40 rounded-2xl overflow-hidden transition-all duration-300 flex flex-col gold-glow-hover" onClick={() => handleSelectCar(car)}>
          ...
          <div className="text-center mt-12">
            <button onClick={() => { setCurrentView('catalog'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="px-8 py-4 rounded-2xl border border-[#D4AF37]/30 hover:border-[#D4AF37] text-[#D4AF37] hover:bg-[#D4AF37] hover:text-neutral-950 font-bold text-xs uppercase tracking-widest transition-all duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <h1 className="text-3xl font-serif font-black text-neutral-900 dark:text-white mt-1">{selectedCar.model}</h1>
                <div className="text-3xl font-serif font-black text-[#D4AF37] mt-2">{selectedCar.price ? selectedCar.price.toLocaleString('fr-FR') : '0'} €</div>
              </div>
              {(() => {
              ...
              <div className="flex gap-3">
                {['specs', 'finance', 'paperwork', 'testdrive'].map(tab => (
                  <button key={tab} onClick={() => setActiveDetailsTab(tab)} className={`px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-wider transition-all ${activeDetailsTab === tab ? 'bg-[#D4AF37] text-neutral-950' : 'bg-neutral-100 dark:bg-[#0D0D0D] border border-neutral-200 dark:border-neutral-800 text-neutral-600 dark:text-neutral-400 hover:border-[#D4AF37]'}`}>
              ...
              {activeDetailsTab === 'specs' && (
                <div className="bg-white dark:bg-[#121214] border border-neutral-200 dark:border-neutral-900 rounded-2xl p-6 space-y-4">
                  <h3 className="text-sm font-serif font-bold text-neutral-900 dark:text-white tracking-wide">{t('techSpecs')}</h3>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div className="flex justify-between"><span className="text-neutral-500 dark:text-neutral-400">{t('modelYear')}</span><span className="font-semibold text-neutral-900 dark:text-white">{selectedCar.year}</span></div>
                    <div className="flex justify-between"><span className="text-neutral-500 dark:text-neutral-400">{t('mileage')}</span><span className="font-semibold text-neutral-900 dark:text-white">{selectedCar.km ? selectedCar.km.toLocaleString('fr-FR') : '0'} km</span></div>
                    <div className="flex justify-between"><span className="text-neutral-500 dark:text-neutral-400">{t('fuel')}</span><span className="font-semibold text-neutral-900 dark:text-white">{t(selectedCar.fuel)}</span></div>
                    <div className="flex justify-between"><span className="text-neutral-500 dark:text-neutral-400">{t('transmission')}</span><span className="font-semibold text-neutral-900 dark:text-white">{t(selectedCar.transmission)}</span></div>
                    <div className="flex justify-between"><span className="text-neutral-500 dark:text-neutral-400">{t('enginePower')}</span><span className="font-semibold text-neutral-900 dark:text-white">{selectedCar.hp} {t('hp')}</span></div>
                    <div className="flex justify-between"><span className="text-neutral-500 dark:text-neutral-400">{t('co2Emissions')}</span><span className="font-semibold text-neutral-900 dark:text-white">{selectedCar.co2} g/km</span></div>
                  </div>
                  {selectedCar.vin && (
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center space-y-3 mb-12">
          <h2 className="text-3xl font-serif text-neutral-900 dark:text-white tracking-wide">{t('vehicleCatalogue')}</h2>
        ...
        {(activeAdminTab === 'vehicles' || !isAdmin) && (
          <>
        <div className="bg-white dark:bg-[#121214] border border-neutral-200 dark:border-neutral-900 rounded-2xl p-6 mb-12 shadow-lg">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full bg-white dark:bg-[#161618] border border-neutral-200 dark:border-neutral-800 focus:border-[#D4AF37] text-neutral-900 dark:text-white rounded-xl py-2.5 px-3 text-xs focus:outline-none transition-all appearance-none cursor-pointer"
              >
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-white dark:bg-[#161618] border border-neutral-200 dark:border-neutral-800 focus:border-[#D4AF37] text-neutral-900 dark:text-white placeholder-neutral-400 dark:placeholder-neutral-500 rounded-xl py-2.5 px-3 text-xs focus:outline-none transition-all"
              />
            </div>
            ...
            <div className="space-y-1.5 sm:col-span-2 md:col-span-3 lg:col-span-3 xl:col-span-3">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white dark:bg-[#161618] border border-neutral-200 dark:border-neutral-800 focus:border-[#D4AF37] text-neutral-900 dark:text-white placeholder-neutral-400 dark:placeholder-neutral-500 rounded-xl py-2.5 pl-10 pr-4 text-xs focus:outline-none transition-all"
                />
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredCars.map((car) => (
              <div 
                key={car.id}
                className="group relative bg-white dark:bg-[#121214] border border-neutral-200 dark:border-neutral-900 hover:border-[#D4AF37]/45 rounded-2xl overflow-hidden transition-all duration-300 flex flex-col gold-glow-hover"
              >
                {/* Картинка и плашки */}
                <div 
